...
class AuthMethods {
  ...
  Future<String> signUpUser({
    ...
    required String userType, // Add userType parameter
    required Map<String, dynamic> additionalData, // Additional data specific to user type
  }) async {
    ...
    try {
      if (email.isNotEmpty && password.isNotEmpty && username.isNotEmpty && userType.isNotEmpty) {
        ...
        Map<String, dynamic> userData = {
          ...
          'username': username,
          'userType': userType,
          ...additionalData, // Merge additional data based on user type
        };
  ...
  Future<Map<String, dynamic>> loginUser({
    required String email,
    required String password,
    required String selectedUserType, // Add selectedUserType parameter
  }) async {
      ...
      if (email.isNotEmpty && password.isNotEmpty && selectedUserType.isNotEmpty) {
        ...
        if (user != null) {
          ...
          if (userDoc.exists) {
            ...
            if (userData != null && userData['userType'] == selectedUserType) {
              res = {
                "status": "success",
                "userData": userData,
              };
            } else {
              res["status"] = "User type selected is not correct";
            }
          } else {
      ...
      if (email.isNotEmpty && password.isNotEmpty) {
        ...
        if (user != null) {
          ...
          if (userDoc.exists) {
            ...
            res["status"] = "User not found. Please sign up.";
          }
        }
      } else {
        res["status"] = "Please enter all the fields";
